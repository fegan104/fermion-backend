...
/**
 * Tests GetMeetingRequest
 * @author ttshiz
 *
 */
public class GetMeetingRequestTest {
	...
	public void test() {
		...
		GetMeetingRequest addMeet = new GetMeetingRequest (calendarId, startTime, endTime, day, guest, location);
